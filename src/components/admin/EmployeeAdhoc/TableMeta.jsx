  ...
  return (
    ...
    >
      {typeFile === "image" ? (
        ...
        <img src={fileSrc} alt="Foto Employee Adhoc" />
      ) : (
        <FilePdfOutlined style={{ fontSize: "32px" }} />
      )}
      <Modal
  ...
  },
  {
    ...
    render: (item) => {
      return (
        <>
          {item.ktp !== null ? (
            <RowFile fileSrc={item?.ktp} typeFile={"image"} />
          ) : (
            ""
          )}
        </>
  ...
  },
  {
    ...
    render: (item) => {
      return (
        <>
          {item.spsp !== null ? (
            <RowFile fileSrc={item?.spsp} typeFile={"pdf"} />
          ) : (
            ""
          )}
        </>
  ...
  },
  {
    ...
    render: (item) => {
      return (
        <>
          {item.spi !== null ? (
            <RowFile fileSrc={item?.spi} typeFile={"pdf"} />
          ) : (
            ""
          )}
        </>
  ...
  },
  {
    ...
    render: (item) => {
      return (
        <>
          {item.stpol !== null ? (
            <RowFile fileSrc={item?.stpol} typeFile={"pdf"} />
          ) : (
            ""
          )}
        </>
  ...
  },
  {
    ...
    render: (item) => {
      return (
        <>
          {item.skes !== null ? (
            <RowFile fileSrc={item?.skes} typeFile={"pdf"} />
          ) : (
            ""
          )}
        </>
  ...
  },
  {
    ...
    render: (item) => {
      return (
        <>
          {item.skck !== null ? (
            <RowFile fileSrc={item?.skck} typeFile={"pdf"} />
          ) : (
            ""
          )}
        </>
  ...
  },
  {
    ...
    render: (item) => {
      return (
        <>
          {item.stskpu !== null ? (
            <RowFile fileSrc={item?.stskpu} typeFile={"pdf"} />
          ) : (
            ""
          )}
        </>
  ...
  },
  {
    ...
    render: (item) => {
      return (
        <>
          {item.sbth !== null ? (
            <RowFile fileSrc={item?.sbth} typeFile={"pdf"} />
          ) : (
            ""
          )}
        </>
  ...
  },
  {
    ...
    render: (item) => {
      return (
        <>
          {item.stpp !== null ? (
            <RowFile fileSrc={item?.stpp} typeFile={"pdf"} />
          ) : (
            ""
          )}
        </>
  ...
  },
  {
    ...
    render: (item) => {
      return (
        <>
          {item.sdom !== null ? (
            <RowFile fileSrc={item?.sdom} typeFile={"pdf"} />
          ) : (
            ""
          )}
        </>
  ...
  },
  {
    ...
    render: (item) => {
      return (
        <>
          {item.kk !== null ? (
            <RowFile fileSrc={item?.kk} typeFile={"pdf"} />
          ) : (
            ""
          )}
        </>
